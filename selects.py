...
def select_nameless_dog():
    return "'''SELECT name FROM dogs WHERE name== 'NULL';'''"
...
def select_name_and_breed_of_dogs_between_age_five_and_ten_ordered_by_oldest_to_youngest():
    return "'''SELECT name, breed FROM dogs WHERE age BETWEEN 5 and 10 ORDER BY age DESC LIMIT 3;'''"

def select_name_age_and_hungry_of_hungry_dogs_between_age_two_and_seven_in_alphabetical_order():
    return "'''SELECT name, age, hungry FROM dogs WHERE hungry == '1' WHERE age BETWEEN 2 and 7 ORDER BY name;'''"
